...
--- @return LuaCraftPlayer|nil @The player object, or `nil` if the player is not found.
--- ```lua
...
--- @return LuaCraftPlayer|nil @The local player object, or `nil` if not available.
--- ```lua
...
--- @return LuaCraftPlayer|nil @The nearest player object, or `nil` if no player is found.
--- ```lua
...
--- @return LuaCraftPlayer|nil @The furthest player object, or `nil` if no player is found.
--- ```lua
...
--- @return table @A list of all entities.
--- ```lua
...
--- @return table @A list of entities of the specified type.
--- ```lua
...
--- @return LuaCraftEntity|nil @The closest entity, or `nil` if no entity is found.
--- ```lua
...
--- @param entityType string? The type of entity to look for (optional).
--- @return LuaCraftEntity|nil @The furthest entity, or `nil` if no entity is found.
--- ```lua
